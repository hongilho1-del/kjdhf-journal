# 한국디지털건강체력연구 온라인 논문투고·심사 시스템

공개 운영 주소: `https://hongilho1-del.github.io/kjdhf-journal/`

건강체력연구소 K2Web의 `온라인 논문 투고·심사` 메뉴는 위 주소를 외부 링크로 연결한다.

국립공주대학교 건강체력연구소가 발행하는 학술지 「한국디지털건강체력연구」의 창간·초기 운영을 위한 실제 데이터 기반 투고·이중맹검 심사 시스템입니다. 기존 홈페이지의 디자인과 JAMS에 가까운 업무 흐름을 유지하면서, 프론트엔드는 정적 배포 가능한 Next.js/Vinext, 인증·데이터·파일은 Supabase로 구성했습니다.
