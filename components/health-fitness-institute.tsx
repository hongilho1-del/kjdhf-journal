  ...
  return (
    <section className="institute-page">
      ...
      <div className="shell institute-content">
        <nav aria-label="현재 위치"><button type="button" onClick={onBackHome}>학술지 홈</button><span>›</span><strong>건강체력연구소</strong></nav>
        ...
        <button className="institute-back" type="button" onClick={onBackHome}>한국디지털건강체력연구로 돌아가기 <span>→</span></button>
      </div>
    </section>
  );
}
