...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [{ url: new URL("logos/health-fitness-institute-logo.png?v=2", siteUrl), type: "image/png" }],
    shortcut: [new URL("logos/health-fitness-institute-logo.png?v=2", siteUrl)],
  },
